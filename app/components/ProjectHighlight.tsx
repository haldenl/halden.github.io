...
const ProjectHighlight: React.FC<ProjectHighlightProps> = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={`group/imgs relative ${hasImg2Title ? "mt-8" : "mt-16"} flex flex-col md:flex-col-reverse md:justify-end`}
      >
